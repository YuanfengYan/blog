...
export default {
  ...
  head() {
    return {
      title: "yanyuanfeng的博客",
      meta: [
        {
          name: "keywords",
          content: "yanyuanfeng,blog,JavaScript,css,html",
        },
        {
          name: "description",
          content: "yanyuanfeng的技术博客",
        },
      ],
    };
  },
  computed: {
    ...
    isEmptyData() {
      return (
        this.article && Array.isArray(this.article.data) && this.article.data.length === 0
      );
    },
  },
  beforeDestroy() {
